...
class ParserModel(Model):
    ...
    def add_embedding(self):
        ...
        """
        ### YOUR CODE HERE
        word_embeddings = self.pretrained_embeddings
    ...
    def add_prediction_op(self):
        ...
        W = xavier_initializer((Config.n_features*Config.embed_size, Config.hidden_size))
        b1 = tf.zeros(shape=(Config.hidden_size,), dtype=tf.float32)
        U = xavier_initializer((Config.hidden_size, Config.n_classes))
        b2 = tf.zeros(shape=(Config.n_classes), dtype=tf.float32)
